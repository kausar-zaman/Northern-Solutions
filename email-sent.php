...
<html lang="en">
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
    ...
    <link href="styles/index.css" rel="stylesheet">
		<title>Northern Solutions | Email Sent</title>
  </head>
  <body>
    <!--Navbar-->
    ...
    <div class="container-fluid" id="about-fluid">
      ...
      <div class="centered"><h1>Thank you!</h1>
      </div>


    </div>

<div class="container" id="email-sent">
  <h2>Your message has been sent. We will be in touch and you will be contacted via email.</h2>
